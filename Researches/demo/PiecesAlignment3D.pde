...
void drawBoundary( OBJModel boundary, int NoV, int bcolor )
{
    stroke(bcolor);
    strokeWeight(2);
...
public void mouseDragged()
{
    ...
    {
        rotZ_scene += (mouseX - pmouseX) * 0.01;
    }
    else
    {
        rotX_scene += (mouseX - pmouseX) * 0.01;
        rotY_scene -= (mouseY - pmouseY) * 0.01;
    }
